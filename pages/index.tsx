          ...
          <div className="bg-white shadow-2xl w-10/12 md:w-5/12 lg:w-4/12 xl:w-3/12 2xl:w-3/12 flex flex-col justify-center items-center rounded-2xl px-4">
            <div className="my-4 p-4 bg-blue w-full rounded-2xl">
              <div className="flex items-center justify-center">
                <QRCode className={`w-full h-full fill-white`} />
              </div>
            </div>
            <h1 className="mt-2 font-bold text-2xl text-dark-navy text-center text-focus-in-first">
              Improve your front-end skills by building projects
            </h1>
            <h2 className="mt-4 mb-10 font-normal text-base text-gray text-center text-focus-in-second">
